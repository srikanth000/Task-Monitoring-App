class UserProjectsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to users_tenant_projects_url(id: @user_project.project_id, tenant_id: @user_project.project.tenant_id), notice:'User successfully removed from the project' }
